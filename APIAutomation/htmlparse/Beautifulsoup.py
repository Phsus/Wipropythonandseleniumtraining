...
# print(soup) # Commented out to keep console clean, but it works
...
# FIXED: Changed 'class' to 'class_' because 'class' is a reserved word in Python
print(soup.find("article", class_="product_pod"))

# FIXED: Defined 'books' so the loop has something to iterate over
books = soup.find_all("article", class_="product_pod")

for book in books:
    title = book.find("h3").find("a")["title"]
    # FIXED: Changed 'class' to 'class_' here as well
